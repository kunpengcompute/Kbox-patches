...
**Figure 1** Kbox cloud phone container architecture<a name="fig89529117514"></a><a id="kbox-cloud-phone-container-architecture"></a>
...
The Kbox cloud phone is developed based on AOSP and currently supports AOSP 11 and AOSP 15. Due to differences in Android versions, the Kbox cloud phone has two code branches to support different Android code.
...
For details about feature changes in each released version, see the *Release Notes*.
...
|Resource Type|Learning Material|Resource Description|
|--|--|--|
...
|Document|Deployment Guide|Provides detailed instructions for deploying a Kbox cloud phone across both bare metal and VM environments.|
...
|--|--|--|--|--|--|
|Kbox11|Long-term branch|Under development|2025/10/15|Maintenance status effective from March 15, 2026|-|
|Kbox15|Long-term branch|Under development|2025/10/15|Maintenance status effective from March 15, 2026|-|
