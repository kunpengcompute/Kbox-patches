...
1. 请参见[1.2-软件环境](#Kbox安卓镜像编译构建软件环境要求)中的链接下载源码包后，解压二进制文件包（BoostKit-boostcph-kbox\_\*\_15.zip），获得Kbox-\*-aosp15.0-binary.zip压缩包，将此压缩包中的“product\_prebuilt“、“products“目录上传至“\~/dependency“目录。
