...
|5|Kbox-AOSP15.zip|内核补丁Demo包、容器部署脚本Demo包。|[获取链接](https://gitcode.com/boostkit/Kbox/tree/AOSP15)|√|√|√|
...
### 4.3 （硬件配置方案三）配置BIOS<a name="ZH-CN_TOPIC_0000002518385436"></a>
...
### 8.3 （硬件配置方案二、三）安装显卡驱动<a name="ZH-CN_TOPIC_0000002518385424"></a>
