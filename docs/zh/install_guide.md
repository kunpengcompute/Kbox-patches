...
**图 2** 内存插入格式<a id="fig10693358191820"></a><a id="内存插入格式"></a>
...
5. 配置内核编译选项。
    ...
    在出现如图所示的内核配置界面中，如[**图 3** 内核配置界面](#内核配置界面)所示，进行内核编译选项的配置，具体配置项如[**表 3** 内核编译选项配置说明](#内核编译选项配置说明)所示。

    **图 3** 内核配置界面<a id="fig4732181117012"></a><a id="内核配置界面"></a>
