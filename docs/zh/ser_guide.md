...
- 方法一：通过获取的软件包查询版本号信息。
    ...
    请参见[zh-cn\_topic\_0000002549712551.md\#zh-cn\_topic\_0000001506119857\_zh-cn\_topic\_0000001323011582\_table1851215264513](zh-cn_topic_0000002549712551.md#zh-cn_topic_0000001506119857_zh-cn_topic_0000001323011582_table1851215264513)中获取并解压BoostKit-boostcph-kbox\_\*.zip，并通过查询kbox\_version.txt文件，确认当前软件包的版本号。
